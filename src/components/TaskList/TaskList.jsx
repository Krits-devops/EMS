    ...
    <div id='tasklist' className='h-[55%] overflow-x-auto flex items-center justify-start gap-5 flex-nowrap w-full py-5'>
        ...
        <div className='h-full flex-shrink-0 w-[300px] p-5 bg-red-400 rounded-xl'>
            <div className='flex justify-between items-center'>
                ...
                <h4 className='text-sm'>12 FEB 2024</h4>
            </div>
            <h2 className='mt-5 text-2xl font-semibold'>Make at git commit</h2>
        ...
        <div className='h-full flex-shrink-0 w-[300px] p-5 bg-emerald-400 rounded-xl'>
            <div className='flex justify-between items-center'>
                <h3 className='bg-red-600 text-sm px-3 py-1 rounded'>High</h3>
                <h4 className='text-sm'>12 FEB 2024</h4>
            </div>
